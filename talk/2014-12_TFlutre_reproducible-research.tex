...
\begin{frame}
  \frametitle{Gather all your R code into a package}
  ...
  Then, version it with git, host it on GitHub, and use the R package \href{https://cran.r-project.org/package=devtools}{devtools} to install it easily on any computer.
\end{frame}
