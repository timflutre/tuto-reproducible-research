...
\institute[INRA]{INRA, UMR AGAP (now UMR GQE)}
\date{08/12/2014*}
...
\begin{frame}
  ...
  See also: \href{http://software-carpentry.org/}{Software Carpentry} and \href{https://www.fun-mooc.fr/courses/course-v1:inria+41016+session01bis/about}{MOOC RR}
\end{frame}
